...
Represents a fitness activity session. During these sessions, the system captures various metrics such as heart rate, pace, or swimming strokes at varying intervals depending on the activity intensity and sensor availability.
